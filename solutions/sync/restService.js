module.exports = function(app, options) {
  ...
  return {
    configureRoutes: function() {
      ...
      routes.put('/widgets/:widgetId', function(req, res) {
      ...
      routes.post('/widgets', function(req, res) {
      ...
      routes.delete('/widgets/:widgetId', function(req, res) {
      ...
      // gets all records
      routes.get('/widgets', function(req, res) {
      ...
      // gets a record by id
      routes.get('/widgets/:widgetId', function(req, res) {
